  ...
  c-1.3,0-2.6,0.5-3.5,1.5c-0.9,0.9-1.5,2.2-1.5,3.5c0,1.3,0.5,2.6,1.5,3.5c0.9,0.9,2.2,1.5,3.5,1.5C47.3,73.2,48.6,72.6,49.5,71.7z"
      ...
      empty: () => (
        ...
        >
          ...
          />
          <path
            d="M71.51,27.42H13.88L69.5,12.48A1.19,1.19,0,0,0,70.38,11l-2.76-10A1,1,0,0,0,67,.18a1.33,1.33,0,0,0-1-.13L0.94,17.5A1.19,1.19,0,0,0,.07,19L2.7,28.93v45.7A1.26,1.26,0,0,0,4,75.89h67.3a1.26,1.26,0,0,0,1.26-1.26V28.81A1,1,0,0,0,71.51,27.42Zm-9.79,2.64L66.24,38H60l-4.52-7.91h6.28Zm-9.17,0L57.07,38H50.79l-4.52-7.91h6.28Zm-9.29,0L47.78,38H41.5L37,30.06h6.28Zm-9.17,0L38.61,38H32.34l-4.52-7.91h6.28Zm-9.17,0L29.45,38H23.17l-4.52-7.91h6.28Zm-9.29,0L20.16,38H13.88L9.36,30.06h6.28ZM11,38H5.47V30.06h1Zm56.63-27.5-5.4,1.38L64.6,3.07l0.88-.25Zm-11.8-5,6-1.63-2.39,8.79-6,1.63ZM46.9,7.84l6-1.63L50.54,15l-6,1.63ZM38,10.22l6-1.63-2.39,8.79L35.6,19Zm-8.91,2.39,6-1.63-2.39,8.79-6,1.63ZM20.16,15l6-1.63L23.8,22.15l-6,1.63Zm-8.91,2.39,6-1.63-2.39,8.79-6,1.63ZM3.08,19.51l5.4-1.38L6.09,26.92l-0.88.25ZM70.25,73.38H5.47V40.48H70.25v32.9Zm0-35.41h-1l-4.52-7.91h5.52V38Z"
            fill="#dbdbdb"
          />
          <rect
            x="15.76"
          ...
          />
          <polygon
            points="59.96 49.15 51.67 49.15 51.67 44.25 49.16 44.25 49.16 49.15 39.12 49.15 39.12 44.25 36.6 44.25 36.6 49.15 26.56 49.15 26.56 44.25 24.05 44.25 24.05 49.15 15.76 49.15 15.76 51.66 59.96 51.66 59.96 49.15"
            fill="#dbdbdb"
          />
          <rect
            x="15.76"
